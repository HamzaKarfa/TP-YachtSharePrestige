            ...
            <div class="f-header__nav" role="navigation">
                <div class="f-header__nav-grid container max-width-lg">
                    ...
                    <ul class="f-header__list">
                        <li class="f-header__item"><a href="" class="f-header__link" aria-current="page">Home</a></li><strong> | </strong>
                        <li class="f-header__item"><a href="" class="f-header__link">Find a Yacht</a> </li><strong> |</strong>
                        <li class="f-header__item"><a href="" class="f-header__link">About us</a></li><strong> |</strong>
                        <li class="f-header__item"><a href="" class="f-header__link">Contact</a></li><strong> |</strong>
                        <li class="f-header__item"><a href="" class="f-header__link">Legal mentions</a></li><strong> |</strong>
                        <li class="f-header__item"><a href="" class="f-header__link">Bog</a></li>
                    </ul>

                    <ul class="f-header__list margin-left-auto@md">
                        <li class="f-header__item"><a href="" class="f-header__btn btn btn--primary">Book a Yacht</a></li>
                    </ul>
                </div>
            </div>
        </nav>
